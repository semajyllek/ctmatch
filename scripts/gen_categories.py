...
from ctmatch.data.data_paths import get_data_tuples
from ctmatch.device import get_pipeline_device
...
def add_condition_category_labels(
    ...
    pipe = pipeline(model=model_checkpoint, device=get_pipeline_device())
    chunk_size = 1000
